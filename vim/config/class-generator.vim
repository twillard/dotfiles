...
function! GenerateClass()
    ...
    execute "normal! o    operator=(const " . classname . "& other);"
    execute "normal! o    operator=(" . classname . "&& other);" 
    execute "normal! o    ~" . classname . "();"
    execute "normal! o};"
    set nopaste
endfunction
...
function! GenerateClassDelete()
    ...
    execute "normal! o    operator=(const " . classname . "& other) = delete;"
    execute "normal! o    operator=(" . classname . "&& other) = delete;"
    execute "normal! o    ~" . classname . "();"
    execute "normal! o};"
    set nopaste
endfunction
